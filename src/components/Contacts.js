                ...
                <div className="container ">
                    <div className="row">
                        <div className="col-lg-3 sec_pad1">
                            <div className="contact_info_item">
                                <h6 className="f_p f_size_20 t_color3 f_500 mb_20">Adresse</h6>
                                <p className="f_400 f_size_15">Orange Digital Center, Lac1, Tunis, Tunisie</p>
                            </div>
                            <div className="contact_info_item">
                                <h6 className="f_p f_size_20 t_color3 f_500 mb_20">Info Contact</h6>
                                <p className="f_400 f_size_15"><span className="f_400 t_color3">Télephone:</span> <a href="tel:25 347 968">(+216) 25 347 968</a></p>
                        ...
                        <div className="contact_form col-lg-8 sec_pad">
                            <h2 className="f_p f_size_22 t_color3 f_600 l_height28 mb_40">Laisser un message</h2>
                            <form onSubmit={this.submitForm} className="contact_form_box" method="post" id="contactForm">
                                <div className="row">
                                    <div className="col-lg-6">
                                        <div className="form-group text_box">
                                            <input type="text" id="name" name="name" placeholder="Votre nom" onChange={this.handleChange}/>
                                        </div>
                                    </div>
                                    <div className="col-lg-6">
                                        <div className="form-group text_box">
                                    ...
                                    <div className="col-lg-12">
                                        <div className="form-group text_box">
                                            <textarea onChange={this.handleChange} name="message" id="message" cols="30" rows="10" placeholder="Taper votre message . . ."></textarea>
                                        </div>
                                    </div>
                                </div>
                            ...
                            {/* {emailStatus ? emailStatus : null} */}
                            <div id="success">Your message est envoyé avec succès!</div>
                            <div id="error">Opps! Il y a un problème. Veuillez réessayer!</div>
                        </div>
                    </div>
