...
export default function StepProgressBar(props) {
    return (
        ...
        <div className="main-content">
          ...
          {/* Header */}
          <div className="header pb-8 pt-5 pt-lg-8 d-flex align-items-center" style={{minHeight: '380px', backgroundImage: back, backgroundSize: 'cover', backgroundPosition: 'center top'}}>
            {/* Mask */}
                  ...
                  <div className="row justify-content-center">
                    <div className="col-lg-3 order-lg-2">
                      <div className="card-profile-image">
                        <a href="#">
                          <img src={localStorage.Avatar}  className="rounded-circle" />
                        </a>
                      </div>
                    </div>
                  </div>
